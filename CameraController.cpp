...
void CameraController::Update() {
	...
	camera_->translation_.y = max(camera_->translation_.x, objectivePoint_.y + targetMargin.bottom);
	camera_->translation_.y = min(camera_->translation_.x, objectivePoint_.y + targetMargin.top);
